...
- [ ] Inspect the receipt's Git SHA, policy hash, command hash, test counts, and unchanged tree digest.
...
- [ ] Freeze the final task packet, public test, protected policy/tests, reference, and negatives with hashes before the Agent turn.
